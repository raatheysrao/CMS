...
if (isset($_POST['submit'])) {
    $ret = mysqli_query($bd, "SELECT * FROM users WHERE userEmail='" . $_POST['username'] . "' 
    ...
    if ($num > 0) {
        ...
        mysqli_query($bd, "INSERT INTO userlog(username, userip, status) 
...
if (isset($_POST['change'])) {
    ...
    $query = mysqli_query($bd, "SELECT * FROM users 
        WHERE userEmail='$email' AND contactNo='$contact'");
    $num = mysqli_fetch_array($query);
    
    if ($num > 0) {
        // Update password
        mysqli_query($bd, "UPDATE users SET password='$password' 
            WHERE userEmail='$email' AND contactNo='$contact'");
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" name="login" method="post">
		        ...
		        <p style="padding-left:4%; padding-top:2%;margin-left:35px;color:red">
		        	<?php if($errormsg){
echo htmlentities($errormsg);
		        		}?></p>

		        		<p style="padding-left:4%; padding-top:2%;margin-left:35px;color:green">
		        	<?php if($msg){
