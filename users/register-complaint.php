...
<label class="col-sm-2 col-sm-2 control-label">Sub-Department </label>
 <div class="col-sm-4">
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Complaint</option>
                  <option value="General Enquires">Appreciation</option>
	          <option value="Report">Inquiries</option>
		  <option value="Contact">Suggestions</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"> Details (max 2000 words) </label>
<div class="col-sm-6">
